...
export MATERIALX_ROOT="${deploy_root}/MaterialX/MaterialX-v1.38.8"
...
export OPENVDB_LOCATION="${deploy_root}/OpenVDB/openvdb-v9.1.0"
export ALEMBIC_DIR="/${deploy_root}/alembic/alembic-v1.8.6"
