#
# Config USD macOS Monterey 12.6 
#
USD_VER="22.11"
RMAN_VER="24.4"
...
cur_dir=`pwd`
tmp_dir="tmp_usd_v${USD_VER}_rman${RMAN_VER}_macos_py${PYTHON_VERSION}"

deploy_root="/Users/mesh/data/tools"
deploy_dir="${deploy_root}/USD/pixar/USD-v${USD_VER}_rman${RMAN_VER}_macos_py${PYTHON_VERSION}"
...
export RENDERMAN_LOCATION="/Applications/Pixar/RenderManProServer-${RMAN_VER}"
