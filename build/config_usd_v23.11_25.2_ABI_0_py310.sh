...
source ./env_python${PY_VER}/bin/activate

cur_dir=`pwd`
tmp_dir="tmp_usd_v${USD_VER}_rman${RMAN_VER}_ABI_0_${PY_VER}"

deploy_root="/data/tools"
deploy_dir="${deploy_root}/USD/pixar/USD-v${USD_VER}_rman${RMAN_VER}_ABI_0_${PY_VER}"
...
export MATERIALX_ROOT="${deploy_root}/MaterialX/MaterialX-v1.38.8_ABI_0"
...
export OPENVDB_LOCATION="${deploy_root}/OpenVDB/openvdb-v9.1.0_ABI_0"
export ALEMBIC_DIR="/${deploy_root}/alembic/alembic-v1.8.6_ABI_0"
