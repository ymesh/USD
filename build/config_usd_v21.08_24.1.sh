...
export MATERIALX_ROOT="${deploy_root}/MaterialX/MaterialX-v1.37.3"
...
export OPENSUBDIV_ROOT_DIR="${deploy_root}/OSD/OpenSubdiv-v3.4.3"
export OPENVDB_LOCATION="${deploy_root}/OpenVDB/openvdb-v7.2.0"
