...
[
    ...
    dict(
        ...
        SCHEMA_INCLUDES=[
            "hdPrman/rileyShadingNodeSchema",
        ...
        MEMBERS=[
            ...
            (
                "name",
                T_TOKEN,
                dict(RILEY_CONVERTER="HdPrman_RileyUniqueString", RILEY_NO_MODIFY=True),
            ),
    ...
    dict(
        ...
        ADD_DEFAULT_LOCATOR=True,
        GENERATE_RILEY_PRIM=True,
        SCHEMA_INCLUDES=["hdPrman/rileySchemaTypeDefs", "hdPrman/rileyParamListSchema"],
        MEMBERS=[
            ("ALL_MEMBERS", "", dict(ADD_LOCATOR=True)),
    ...
    dict(
        ...
        MEMBERS=[
            ...
            (
                ...
                T_PATH,
                dict(
                    RILEY_RELATIONSHIP_TARGET="RileyGeometryPrototype",
            ...
            ("material", T_PATH, dict(RILEY_RELATIONSHIP_TARGET="RileyMaterial")),
            (
                "coordsys",
                T_PATHARRAY,
    ...
    dict(
        ...
        MEMBERS=[
            ("ALL_MEMBERS", "", dict(ADD_LOCATOR=True)),
            ("type", T_TOKEN, dict(RILEY_NO_MODIFY=True)),
            (
                "displacement",
                T_PATH,
    ...
    dict(
        ...
        MEMBERS=[
            ...
            ("material", T_PATH, dict(RILEY_RELATIONSHIP_TARGET="RileyMaterial")),
            ("lightShader", T_PATH, dict(RILEY_RELATIONSHIP_TARGET="RileyLightShader")),
            (
                "coordsys",
                T_PATHARRAY,
                dict(RILEY_RELATIONSHIP_TARGET="RileyCoordinateSystem"),
    ...
    dict(
        ...
        MEMBERS=[
            ("ALL_MEMBERS", "", dict(ADD_LOCATOR=True)),
            ("name", T_TOKEN, {}),
            ("type", T_TOKEN, dict(RILEY_CONVERTER="HdPrman_RileyRenderOutputType")),
            ("source", T_TOKEN, {}),
            ("accumulationRule", T_TOKEN, {}),
            ("filter", T_TOKEN, {}),
            ("filterSize", T_VEC2F, dict(RILEY_CONVERTER="HdPrman_RileyFilterSize")),
            ("relativePixelVariance", T_FLOAT, dict(FALLBACK_VALUE="1.0f")),
            ("params", "HdPrmanRileyParamListSchema", {}),
        ],
        STATIC_TOKEN_DATASOURCE_BUILDERS=[
    ...
    dict(
        ...
        MEMBERS=[
            ...
            ("extent", T_VEC3I, dict(RILEY_CONVERTER="HdPrman_RileyExtent")),
            ("filterMode", T_TOKEN, {}),
            ("pixelVariance", T_FLOAT, dict(FALLBACK_VALUE="1.0f")),
            ("params", "HdPrmanRileyParamListSchema", {}),
        ],
        STATIC_TOKEN_DATASOURCE_BUILDERS=[
    ...
    dict(
        ...
        MEMBERS=[
            ...
            ("camera", T_PATH, dict(RILEY_RELATIONSHIP_TARGET="RileyCamera")),
            ("integrator", T_PATH, dict(RILEY_RELATIONSHIP_TARGET="RileyIntegrator")),
            (
                "displayFilters",
                T_PATHARRAY,
